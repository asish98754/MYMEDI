...
public class TinyDB {
    ...
    public ArrayList<RecommendDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<RecommendDomain> playerList =  new ArrayList<RecommendDomain>();

        for(String jObjString : objStrings){
            RecommendDomain player  = gson.fromJson(jObjString,  RecommendDomain.class);
    ...
    public void putListObject(String key, ArrayList<RecommendDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(RecommendDomain player: playerList){
